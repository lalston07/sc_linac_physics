...
cavity_data = extracting_data(cavity_faultname, timestamp)
forward_data = extracting_data(forward_pow, timestamp)
reverse_data = extracting_data(reverse_pow, timestamp)
decay_data = extracting_data(decay_ref, timestamp)
time_data = extracting_data(time_range, time_timestap)
